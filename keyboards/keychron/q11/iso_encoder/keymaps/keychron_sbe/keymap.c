...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_92_iso(
        ...
        _______,  MO(BACKSPACE),  MT(MOD_LGUI,KC_A),   MT(MOD_LCTL,KC_S),  MT(MOD_LALT,KC_D),   MT(MOD_LSFT,KC_F), KC_G,     KC_H,     MT(MOD_LSFT,KC_J),  MT(MOD_LALT,KC_K),  MT(MOD_LCTL,KC_L),  KC_SCLN,  KC_QUOT,    KC_NUHS,  KC_ENT, KC_HOME,
