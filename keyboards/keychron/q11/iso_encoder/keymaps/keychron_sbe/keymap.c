...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_92_iso(
        ...
        TO(BASE),  KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,            KC_PGUP,
        TO(SYMBOL),  KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,      KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,    KC_RBRC,                      KC_PGDN,
        TO(GAMING),  LT(BACKSPACE,KC_BSPC), LT(GAMING,KC_A), MT(MOD_LCTL,KC_S), MT(MOD_LALT,KC_D), MT(MOD_LSFT,KC_F), KC_G, KC_H, MT(MOD_LSFT,KC_J), MT(MOD_LALT,KC_K), MT(MOD_LCTL,KC_L), KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT, KC_HOME,
        TO(BACKSPACE),  KC_LSFT,  KC_NUBS,  KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,
    ...
    [GAMING] = LAYOUT_92_iso(
        ...
        _______,     KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,      KC_H,     KC_LEFT,  KC_DOWN,   KC_RGHT, KC_SCLN,  KC_QUOT,    KC_NUHS,  KC_ENT,             KC_HOME,
...
bool rgb_matrix_indicators_user(void) {
	    switch(get_highest_layer(layer_state|default_layer_state)) {
		    case BASE:
                ...
                rgb_matrix_set_color(2,255,0,198);
                rgb_matrix_set_color(5,80,250,0);
                rgb_matrix_set_color(9,241,250,0);
                rgb_matrix_set_color(13,100,0,255);
                rgb_matrix_set_color(17,255,0,198);
                rgb_matrix_set_color(21,80,250,0);
                rgb_matrix_set_color(25,241,250,0);
                rgb_matrix_set_color(28,100,0,255);
                rgb_matrix_set_color(31,255,0,198);
                rgb_matrix_set_color(34,80,250,0);
                rgb_matrix_set_color(37,241,250,0);
                rgb_matrix_set_color(40,100,0,255);
                rgb_matrix_set_color(43,255,0,198);
                rgb_matrix_set_color(47,80,250,0);
                rgb_matrix_set_color(50,241,250,0);
                rgb_matrix_set_color(53,100,0,255);
                break;
            case SYMBOL:
                rgb_matrix_set_color_all(0,0,0);
            ...
            case GAMING:
                rgb_matrix_set_color_all(0,0,0);
                rgb_matrix_set_color(22,241,250,0);
                rgb_matrix_set_color(2,255,0,198);
                rgb_matrix_set_color(5,80,250,0);
                rgb_matrix_set_color(9,241,250,0);
                rgb_matrix_set_color(13,100,0,255);
            ...
            case BACKSPACE:
                rgb_matrix_set_color_all(0,0,0);
                rgb_matrix_set_color(29,100,0,255);
                rgb_matrix_set_color(2,255,0,198);
                rgb_matrix_set_color(5,80,250,0);
                rgb_matrix_set_color(9,241,250,0);
                rgb_matrix_set_color(13,100,0,255);
